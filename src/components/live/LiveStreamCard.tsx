      ...
      >
        ...
        <div className="absolute top-2.5 left-2.5">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-red-600 shadow-lg shadow-red-600/20 backdrop-blur-sm border border-red-500/30">
            ...
            <span className="text-white text-2xs font-black tracking-widest uppercase leading-none">Live</span>
          </div>
        </div>
        
        <div className="absolute top-2.5 right-2.5">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white text-2xs font-semibold">
    ...
    >
      ...
      <div className="absolute top-2.5 left-2.5">
        <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-red-600 shadow-lg shadow-red-600/20 backdrop-blur-sm border border-red-500/20">
          ...
          <span className="text-white text-2xs font-black tracking-widest uppercase">Live</span>
        </div>
      </div>
      
      <div className="absolute top-2.5 right-2.5">
        <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white text-2xs font-semibold">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-3 transform translate-y-0.5 group-hover:translate-y-0 transition-transform">
        <h3 className="text-white text-xs font-bold mb-1 line-clamp-2 drop-shadow-sm group-hover:text-purple-200 transition-colors">{stream.title}</h3>
  ...
  return (
    <div className="flex items-center justify-between mb-5 px-1">
      <div className="flex items-center gap-2.5">
        {icon}
        <div>
          <h2 className="text-gray-900 text-sm font-bold tracking-tight">{title}</h2>
          <p className="text-2xs text-gray-400 font-medium uppercase tracking-wider leading-none mt-0.5">{subtitle}</p>
        </div>
      </div>
