                ...
                <div className="px-4 py-4 space-y-4">
                  <div className="rounded-2xl border border-red-200 bg-red-50 p-4">
                    ...
                    <button
                      ...
                      className="w-full mt-4 py-3 rounded-xl text-white font-semibold bg-primary hover:bg-primary-dark transition-all"
                    >
                      Continue Live
                    </button>
                  </div>
                  ...
                  <div className="bg-gray-100 p-1 rounded-xl flex">
                    <button
                      ...
                      className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${
                        tab === 'instant' ? 'bg-white text-primary shadow-sm' : 'text-gray-600'
                      }`}
                    >
                      Go Live Now
                    </button>
                    <button
                      ...
                      className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${
                        tab === 'from_event' ? 'bg-white text-primary shadow-sm' : 'text-gray-600'
                      }`}
                    >
                      From Event
                    </button>
