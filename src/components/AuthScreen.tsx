            ...
            <TabsContent value="login" className="mt-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <button
                  ...
                  className="h-11 min-w-0 rounded-xl bg-black px-3 text-sm font-semibold text-white transition-colors hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-50 inline-flex items-center justify-center gap-2"
                >
                  {isAppleSubmitting ? (
                    <span className="inline-flex items-center justify-center">
                      <Loader2 className="animate-spin -ml-1 mr-2 h-4 w-4" />
                    ...
                    <>
                      <img src={appleIcon} alt="" aria-hidden="true" className="h-4 w-4 shrink-0 object-contain" />
                ...
                <button
                  ...
                  className="h-11 min-w-0 rounded-xl border border-gray-200 bg-white px-3 text-sm font-semibold text-gray-900 transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 inline-flex items-center justify-center gap-2"
                >
                  {isGoogleSubmitting ? (
                    <span className="inline-flex items-center justify-center">
                      <Loader2 className="animate-spin -ml-1 mr-2 h-4 w-4" />
